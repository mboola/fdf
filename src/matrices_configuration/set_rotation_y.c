...
void	set_rotation_y(t_mlx_data *mlx_data)
{
	...
	mlx_data->rotation_y[0][2] = negative_sin;
	mlx_data->rotation_y[0][3] = return_zero;
	mlx_data->rotation_y[1][0] = return_zero;
	mlx_data->rotation_y[1][1] = return_one;
	mlx_data->rotation_y[1][2] = return_zero;
	mlx_data->rotation_y[1][3] = return_zero;
	mlx_data->rotation_y[2][0] = sin;
	mlx_data->rotation_y[2][1] = return_zero;
	mlx_data->rotation_y[2][2] = cos;
	mlx_data->rotation_y[2][3] = return_zero;
	mlx_data->rotation_y[3][0] = return_zero;
	mlx_data->rotation_y[3][1] = return_zero;
	mlx_data->rotation_y[3][2] = return_zero;
	mlx_data->rotation_y[3][3] = return_one;
}
